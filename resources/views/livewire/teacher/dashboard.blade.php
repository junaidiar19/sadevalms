<div class="min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900">
    ...
    <nav class="border-b border-white/10 px-6 py-4 flex items-center justify-between">
        <div class="flex items-center gap-3">
            <div class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-600 shadow-lg shadow-emerald-500/30">
    ...
    <main class="flex items-center justify-center min-h-[calc(100vh-65px)] p-6">
        <div class="text-center">
            <span class="inline-block px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-medium mb-4">
                Teacher
            </span>
            <h1 class="text-3xl font-bold text-white mb-2">Welcome back, {{ $user->name }}!</h1>
            <p class="text-slate-400 text-sm">Your Teacher dashboard is ready. Content coming soon.</p>
        </div>
    </main>
</div>
